...
namespace Channa.Controllers
{
    public class PembelisController : Controller
    {
        ...
        public PembelisController(ikanContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembeli,Nama,Alamat,NoHp")] Pembeli pembeli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembeli,Nama,Alamat,NoHp")] Pembeli pembeli)
        {

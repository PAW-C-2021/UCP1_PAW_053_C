...
namespace Channa.Controllers
{
    public class PembayaransController : Controller
    {
        ...
        public PembayaransController(ikanContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Pembayaran.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembayaran,IdTransaksi,IdPenjual,TotalPembayaran,TanggalPembayaran")] Pembayaran pembayaran)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembayaran,IdTransaksi,IdPenjual,TotalPembayaran,TanggalPembayaran")] Pembayaran pembayaran)
        {

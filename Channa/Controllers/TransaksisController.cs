...
namespace Channa.Controllers
{
    public class TransaksisController : Controller
    {
        ...
        public TransaksisController(ikanContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTransaksi,IdIkan,IdPembeli,JumlahTransaksi,TanggalTransaksi")] Transaksi transaksi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTransaksi,IdIkan,IdPembeli,JumlahTransaksi,TanggalTransaksi")] Transaksi transaksi)
        {

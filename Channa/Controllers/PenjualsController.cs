...
namespace Channa.Controllers
{
    public class PenjualsController : Controller
    {
        ...
        public PenjualsController(ikanContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPenjual,Nama,Alamat,NoHp")] Penjual penjual)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPenjual,Nama,Alamat,NoHp")] Penjual penjual)
        {
